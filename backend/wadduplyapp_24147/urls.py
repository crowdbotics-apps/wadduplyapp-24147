"""wadduplyapp_24147 URL Configuration
...
admin.site.site_header = "WADDUPLYAPP"
admin.site.site_title = "WADDUPLYAPP Admin Portal"
admin.site.index_title = "WADDUPLYAPP Admin"

# swagger
api_info = openapi.Info(
    title="WADDUPLYAPP API",
    default_version="v1",
    description="API documentation for WADDUPLYAPP App",
)
